            ...
            <div class="col-lg-4 col-sm-6">
                <div class="rs-featured-2__item">
                    ...
                    <div class="rs-content">
                        ...
                        <h4 class="title"><a href="service-details">UI/UX Design</a></h4>
                        <p>Bring to the table win-win survival strategies to ensure proactive domination.</p>
                        <div class="rs-link">
                            <a class="rs-link" href="service-details">Read More <i
                                    class="ri-arrow-right-fill"></i></a>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="rs-featured-2__item">
                    ...
                    <div class="rs-content">
                        ...
                        <h4 class="title"><a href="service-details">Digital Marketing</a></h4>
                        <p>Bring to the table win-win survival strategies to ensure proactive domination.</p>
                        <div class="rs-link">
                            <a class="rs-link" href="service-details">Read More <i
                                    class="ri-arrow-right-fill"></i></a>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="rs-featured-2__item">
                    ...
                    <div class="rs-content">
                        ...
                        <h4 class="title"><a href="service-details">Data Analytics</a></h4>
                        <p>Bring to the table win-win survival strategies to ensure proactive domination.</p>
                        <div class="rs-link">
                            <a class="rs-link" href="service-details">Read More <i
                                    class="ri-arrow-right-fill"></i></a>
                ...
                <div class="rs-pricing__item">
                    ...
                    <div class="rs-pricing__body">
                        <ul>
                            ...
                            <li class="list disabled"><i class="ri-checkbox-blank-circle-line"></i> Multi-Language
                                Content</li>
                            <li class="list disabled"><i class="ri-checkbox-blank-circle-line"></i> Data backup and
                                recovery</li>
                            <li class="list disabled"><i class="ri-checkbox-blank-circle-line"></i> Synced To Cloud
                                Database</li>
                        </ul>
                        <a class="main-btn" href="contact">Get Started <i class="ri-arrow-right-fill"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="rs-pricing__item">
                    ...
                    <div class="rs-pricing__body">
                        <ul>
                            <li class="list disabled"><i class="ri-checkbox-blank-circle-line"></i> 30 Days Trial
                                Features</li>
                            <li class="list"><i class="ri-checkbox-circle-line"></i> Unlimited Features</li>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="rs-pricing__item last-item">
                    ...
                    <div class="rs-pricing__body">
                        <ul>
                            <li class="list"><i class="ri-checkbox-circle-line"></i> 30 Days Trial Features</li>
                            <li class="list disabled"><i class="ri-checkbox-blank-circle-line"></i> Unlimited Features
                            </li>
                            <li class="list disabled"><i class="ri-checkbox-blank-circle-line"></i> Multi-Language
                                Content</li>
                            <li class="list disabled"><i class="ri-checkbox-blank-circle-line"></i> Data backup and
