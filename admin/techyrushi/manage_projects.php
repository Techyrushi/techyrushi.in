...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['delete_id'])) {
        ...
        if (isset($_FILES['gallery_images'])) {
            ...
            if (!is_dir($target_dir_gallery)) mkdir($target_dir_gallery, 0777, true);
        
            for ($i = 0; $i < $total_files; $i++) {
                if ($_FILES['gallery_images']['error'][$i] == 0) {
                    $filename_gallery = time() . "_" . $i . "_" . basename($_FILES['gallery_images']['name'][$i]);
                    $target_file_gallery = $target_dir_gallery . $filename_gallery;
                    
                    if (move_uploaded_file($_FILES['gallery_images']['tmp_name'][$i], $target_file_gallery)) {
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control" id="editor" rows="10"><?php echo htmlspecialchars($project['description']); ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Core Technologies</label>
                                        <input type="text" name="core_technologies" class="form-control" value="<?php echo htmlspecialchars($project['core_technologies']); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Industry</label>
                                        <input type="text" name="industry" class="form-control" value="<?php echo htmlspecialchars($project['industry']); ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Client Name</label>
                                        <input type="text" name="client_name" class="form-control" value="<?php echo htmlspecialchars($project['client_name']); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Project Date</label>
                                        <input type="date" name="project_date" class="form-control" value="<?php echo htmlspecialchars($project['project_date']); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Project Link</label>
                                        <input type="text" name="project_link" class="form-control" value="<?php echo htmlspecialchars($project['project_link']); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Country</label>
                                        <input type="text" name="country" class="form-control" value="<?php echo htmlspecialchars($project['country']); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Cost</label>
                                        <input type="text" name="cost" class="form-control" value="<?php echo htmlspecialchars($project['cost']); ?>">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <?php if ($project['image']): ?>
                                            <div class="mt-2">
                                                <img src="../../assets/images/project/<?php echo $project['image']; ?>" width="100">
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <?php if ($project['brochure']): ?>
                                            <div class="mt-2">
                                                <a href="../../assets/files/project/<?php echo $project['brochure']; ?>" target="_blank">View Brochure</a>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    <div class="form-group">
                                            ...
                                            <div class="mt-2 row">
                                                <?php foreach ($gallery_images as $img): ?>
                                                    <div class="col-md-4 mb-2">
                                                        <img src="../../assets/images/project/gallery/<?php echo $img['image_path']; ?>" class="img-fluid">
                                                        <a href="manage_projects.php?action=delete_gallery_image&id=<?php echo $img['id']; ?>&project_id=<?php echo $project['id']; ?>" class="text-danger" onclick="return confirm('Delete this image?')">Remove</a>
                                                    </div>
                                                <?php endforeach; ?>
                                            </div>
                                        <?php endif; ?>
