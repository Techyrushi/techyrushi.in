...
//Project:	Techyrushi Admin - Responsive Admin Template
...
!function($) {
            ...
            $this.$modal.find('form').on('submit', function () {
                ...
                $.ajax({
                    ...
                    data: JSON.stringify({
                        ...
                        end: calEvent.end ? calEvent.end.format('YYYY-MM-DD HH:mm:ss') : null,
    ...
    CalendarApp.prototype.init = function() {
        ...
        $this.$calendarObj = $this.$calendar.fullCalendar({
            ...
            events: 'api/events.php', // Load from API
            editable: true,
            ...
            eventDrop: function(event, delta, revertFunc) {
                $.ajax({
                    ...
                    data: JSON.stringify({
                        ...
                        className: event.className ? event.className[0] : null
                    }),
                    contentType: 'application/json',
                    error: function() {
                        revertFunc();
